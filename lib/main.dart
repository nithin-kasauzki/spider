                  ...
                  children: [
                    ...
                    (){
                      ...
                      if(myController.text!=null && myController.text!='' && isNumeric(myController.text)){
                        ...
                        unit[cls_index].Convert(startValue1, startValue2, userInput);
                        convertedMeasure=(unit[cls_index].converted);
                        convertedMeasurestr=convertedMeasure.toStringAsFixed(3);
                        History.insert(0,Text('$userInput $startValue1 -> $convertedMeasurestr $startValue2'));
                        print(History);
